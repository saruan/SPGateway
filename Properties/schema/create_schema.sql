...
CREATE TABLE IF NOT EXISTS `gateway_cluster` (
  ...
  `main_yn` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'N',
...
INSERT INTO `gateway_cluster` (`gateway_id`, `secret_key`, `main_yn`, `expired_time`) VALUES
	('COMMON_CLUSTER', 'Cq91Ql5po/mjaRT5g0Nbsc04wVdPIJxPeHH3H7hELQyB974TXQturOOUWnfLc9e\r\nXEhSPvgp/yiNdstyqpWZ2w==', 'Y', 3600);
...
CREATE TABLE IF NOT EXISTS `oauth_access_token` (
  ...
  `refresh_token` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '리프레시 토큰',
  `additional_info` varchar(512) DEFAULT NULL,
  PRIMARY KEY (`authentication_id`),
  UNIQUE KEY `token_id` (`token_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Access 토킅 테이블';

-- 테이블 데이터 auth.oauth_access_token:~112 rows (대략적) 내보내기
/*!40000 ALTER TABLE `oauth_access_token` DISABLE KEYS */;
/*!40000 ALTER TABLE `oauth_access_token` ENABLE KEYS */;

-- 테이블 auth.oauth_client_details 구조 내보내기
CREATE TABLE IF NOT EXISTS `oauth_client_details` (
  `client_id` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '클라이언트 ID',
  `resource_ids` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '리소스 정보',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='인증 클라이언트 정보 테이블';

-- 테이블 데이터 auth.oauth_client_details:~2 rows (대략적) 내보내기
/*!40000 ALTER TABLE `oauth_client_details` DISABLE KEYS */;
INSERT INTO `oauth_client_details` (`client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`) VALUES
	('client2', NULL, '{bcrypt}$2a$10$iP9ejueOGXO29.Yio7rqeuW9.yOC4YaV8fJp3eIWbP45eZSHFEwMG', 'read_profile,read_posts', 'password,client_credentials,refresh_token', 'http://localhost:7777/callback', NULL, 3600, 6000, NULL, 'false'),
	('GatewayPortal', NULL, '{bcrypt}$2a$10$MF5yVMGCeH66dJ8I26n.5O/Q4X/PhGv9qndFQ1Vf7t/lFGULU9hjG', 'read_profile', 'password,client_credentials,refresh_token', NULL, NULL, 3600, 6000, NULL, NULL);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='리프레시 토큰 테이블';
...
CREATE TABLE IF NOT EXISTS `sp_apis` (
  ...
  PRIMARY KEY (`API_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='API 관리 테이블';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='새 테이블3';
...
INSERT INTO `sp_groups` (`GROUP_ID`, `GROUP_NM`, `REG_DT`, `UPT_DT`, `REG_USER_NO`, `UPT_USER_NO`) VALUES
	(1, '관리자 그룹', '2020-11-09 10:40:35', '2020-11-09 10:40:35', 'initialize', 'initialize');
...
CREATE TABLE IF NOT EXISTS `sp_menus` (
  ...
  `UPT_USER_NO` varchar(20) DEFAULT NULL COMMENT '수정자',
  PRIMARY KEY (`MENU_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='메뉴 관리 테이블';
...
CREATE TABLE IF NOT EXISTS `sp_roles` (
  ...
  `UPT_USER_NO` varchar(20) DEFAULT NULL COMMENT '수정자',
  PRIMARY KEY (`ROLE_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='권한 테이블2';

-- 테이블 데이터 auth.sp_roles:~1 rows (대략적) 내보내기
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='권한-API 매핑';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='권한-메뉴 매핑';
...
CREATE TABLE IF NOT EXISTS `sp_users` (
  ...
  `PASSWORD` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '비밀번호',
  `REG_DT` datetime DEFAULT NULL COMMENT '등록일',
  `UPT_DT` datetime DEFAULT NULL COMMENT '수정일',
  `REG_USER_NO` varchar(20) DEFAULT NULL COMMENT '등록자',
  `UPT_USER_NO` varchar(20) DEFAULT NULL COMMENT '수정자',
  PRIMARY KEY (`USER_ID`,`GROUP_ID`,`ROLE_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자 테이블2';
...
INSERT INTO `sp_users` (`USER_ID`, `GROUP_ID`, `ROLE_ID`, `USER_NM`, `USER_LOGIN_ID`, `PASSWORD`, `REG_DT`, `UPT_DT`, `REG_USER_NO`, `UPT_USER_NO`) VALUES
	(1, 1, 1, '구경태', 'saruan', 'rudxo1', '2020-11-09 10:41:42', '2020-11-09 10:41:43', 'initialize', 'initialize');
/*!40000 ALTER TABLE `sp_users` ENABLE KEYS */;


-- gateway 데이터베이스 구조 내보내기
CREATE DATABASE IF NOT EXISTS `gateway` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `gateway`;
...
CREATE TABLE IF NOT EXISTS `gw_app` (
  ...
  `UPT_DT` datetime DEFAULT NULL COMMENT '수정일',
  PRIMARY KEY (`APP_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='앱 관리 테이블';

-- 테이블 데이터 gateway.gw_app:~4 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `gw_error_log` (
  ...
  `REG_USER_NO` varchar(20) DEFAULT NULL COMMENT '등록자',
  PRIMARY KEY (`GUID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='오류 로그 테이블';

-- 테이블 데이터 gateway.gw_error_log:~301 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `gw_service` (
  ...
  `SERVICE_TARGET_URL` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '목적지 URL',
  `SERVICE_NM` varchar(20) NOT NULL COMMENT '서비스명',
  `SERVICE_LOGIN_TYPE` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '1' COMMENT '로그인 타입',
  `SERVICE_AUTH_TYPE` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '1' COMMENT 'API 인증 타입',
...
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='라우팅 서비스 테이블';
...
INSERT INTO `gw_service` (`SERVICE_ID`, `SERVICE_PATH`, `SERVICE_TARGET_URL`, `SERVICE_NM`, `SERVICE_LOGIN_TYPE`, `SERVICE_AUTH_TYPE`, `SERVICE_DESC`, `USE_YN`, `FILTER_ID`, `REG_USER_NO`, `UPT_USER_NO`, `REG_DT`, `UPT_DT`) VALUES
	(41, '/api/filter', 'http://localhost:8080/api/service/v1/filter/', '필터 서비스', 'OAUTH', 'PUBLIC', '필터 Service', 'Y', 3, '1', '1', '2020-07-07 16:29:59', '2020-11-05 17:27:29'),
	(45, '/api/routes', 'http://localhost:8080/api/service/v1/routes/', '라우팅 서비스', 'OAUTH', 'SECURITY', '라우팅 Service', 'Y', 1, '1', NULL, '2020-09-02 14:48:26', '2020-09-02 14:48:26');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='새 테이블2';

-- 테이블 데이터 gateway.gw_service_app_mapping:~6 rows (대략적) 내보내기
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='서비스 필터 테이블';
...
-- 테이블 데이터 gateway.sp_apis:~3 rows (대략적) 내보내기
/*!40000 ALTER TABLE `sp_apis` DISABLE KEYS */;
INSERT INTO `sp_apis` (`API_ID`, `API_NM`, `API_URL`, `USE_YN`, `REG_DT`, `UPT_DT`, `REG_USER_NO`, `UPT_USER_NO`) VALUES
	(1, '포탈_API 관리', '/portal/service/v1/routes', 'Y', '2020-11-04 15:59:25', '2020-11-04 15:59:26', '1', '1'),
	(2, '포탈 APP 관리', '/portal/service/v1/app', 'Y', '2020-11-04 16:12:02', '2020-11-04 16:12:03', '1', '1'),
...
CREATE TABLE IF NOT EXISTS `sp_menus` (
  ...
  PRIMARY KEY (`MENU_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='메뉴 관리 테이블';
...
CREATE TABLE IF NOT EXISTS `sp_roles` (
  ...
  PRIMARY KEY (`ROLE_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='권한 테이블';
...
-- 테이블 데이터 gateway.sp_role_api_mapping:~3 rows (대략적) 내보내기
/*!40000 ALTER TABLE `sp_role_api_mapping` DISABLE KEYS */;
INSERT INTO `sp_role_api_mapping` (`API_ID`, `ROLE_ID`) VALUES
	(1, 1),
	(2, 1),
...
CREATE TABLE IF NOT EXISTS `sp_users` (
  ...
  `UPT_USER_NO` varchar(20) DEFAULT NULL COMMENT '수정자',
  PRIMARY KEY (`USER_ID`,`GROUP_ID`,`ROLE_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자 테이블';
...
CREATE DATABASE IF NOT EXISTS `servicelog` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `servicelog`;
...
CREATE TABLE IF NOT EXISTS `service_log` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='서비스 로그 테이블';
