 ...
 *  </pre>
 */
public class GwFilterControllerTest extends DefaultTestConfig {
  ...
  void 필터_조회() throws Exception{
    ...
    mockMvc.perform(get("/api/service/v1/filter/")
  ...
  void 필터_상세_조회() throws Exception{
    ...
    mockMvc.perform(RestDocumentationRequestBuilders.get("/api/service/v1/filter/{id}", 1L)
        .contentType(MediaType.APPLICATION_JSON)
        .accept(MediaType.APPLICATION_JSON))
        .andDo(print())
        .andExpect(status().isOk())
  ...
  void 필터_신규_등록() throws Exception{
    ...
    mockMvc.perform(RestDocumentationRequestBuilders.post("/api/service/v1/filter/")
        .contentType(MediaType.APPLICATION_JSON)
        .content(requestBody)
        .accept(MediaType.APPLICATION_JSON))
        .andDo(print())
  ...
  void 필터_수정() throws Exception{
    ...
    mockMvc.perform(RestDocumentationRequestBuilders.put("/api/service/v1/filter/{id}", 1L)
        .contentType(MediaType.APPLICATION_JSON)
        .content(requestBody)
        .accept(MediaType.APPLICATION_JSON))
        .andDo(print())
  ...
  void 필터_삭제() throws Exception{
    ...
    mockMvc.perform(RestDocumentationRequestBuilders.delete("/api/service/v1/filter/{id}", 41L)
        .contentType(MediaType.APPLICATION_JSON)
        .accept(MediaType.APPLICATION_JSON))
        .andDo(print())
        .andExpect(status().isOk())
  ...
  void 필터_신규_등록_파라미터_누락() throws Exception{
    ...
    ResultActions resultActions = mockMvc.perform(RestDocumentationRequestBuilders.post("/api/service/v1/filter/")
        .contentType(MediaType.APPLICATION_JSON)
        .content(requestBody)
        .accept(MediaType.APPLICATION_JSON))
        .andDo(print())
  ...
  void 필터_수정_파라미터_누락() throws Exception{
    ...
    ResultActions resultActions = mockMvc
        .perform(RestDocumentationRequestBuilders
            .put("/api/service/v1/filter/{id}", 1L)
        .contentType(MediaType.APPLICATION_JSON)
        .content(requestBody)
        .accept(MediaType.APPLICATION_JSON))
        .andDo(print())
